...
NAME = "GNDIF_ReceiveError"
ID  = 0x180
SEVERITY = "WARNING_HI"
FORMAT_STRING = "Error %s on port_number %d"
EVENT_DESCRIPTION = "Error in GndIf receiving packet"

# Set arguments list with default values here.
ARGUMENTS = [
    ("error","The error code",EnumType("GNDIF_RECEIVE_ERROR",{"GNDIF_PacketTooBig":0,"GNDIF_PacketReadError":1,"GNDIF_ReadSizeMismatch":2,})),
