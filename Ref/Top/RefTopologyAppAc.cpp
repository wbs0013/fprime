...
void constructRefArchitecture(void) {
    ...
    //None
    manager.set_CmdReg_OutputPort(0, cmdDisp.get_compCmdReg_InputPort(20));
    //None
    manager.set_CmdStatus_OutputPort(0, cmdDisp.get_compCmdStat_InputPort(0));
    //None
    manager.set_Log_OutputPort(0, eventLogger.get_LogRecv_InputPort(0));
    //None
    manager.set_LogText_OutputPort(0, textLogger.get_TextLogger_InputPort(0));
    //None
    manager.set_Tlm_OutputPort(0, chanTlm.get_TlmRecv_InputPort(0));
    //None
    manager.set_Time_OutputPort(0, linuxTime.get_timeGetPort_InputPort(0));
    //None
    manager.set_driverOut_OutputPort(0, driver.get_driverIn_InputPort(0));
    //None
    scheduler.set_CmdReg_OutputPort(0, cmdDisp.get_compCmdReg_InputPort(22));
    //None
    scheduler.set_CmdStatus_OutputPort(0, cmdDisp.get_compCmdStat_InputPort(0));
    //None
    scheduler.set_Tlm_OutputPort(0, chanTlm.get_TlmRecv_InputPort(0));
    //None
    scheduler.set_Time_OutputPort(0, linuxTime.get_timeGetPort_InputPort(0));
    //None
    scheduler.set_schedulerOut_OutputPort(0, manager.get_schedulerIn_InputPort(0));
    //None
    driver.set_Log_OutputPort(0, eventLogger.get_LogRecv_InputPort(0));
    //None
    driver.set_LogText_OutputPort(0, textLogger.get_TextLogger_InputPort(0));
    //None
    driver.set_Tlm_OutputPort(0, chanTlm.get_TlmRecv_InputPort(0));
    //None
