...
namespace Ref {
  ...
  PROTECTED:
    ...
    enum {
      CHANNELID_PKTSTATE = 0, //!< Channel ID for PktState
      CHANNELID_SENSOR1 = 1, //!< Channel ID for Sensor1
      CHANNELID_SENSOR2 = 2, //!< Channel ID for Sensor2
      CHANNELID_PARAMETER1 = 3, //!< Channel ID for Parameter1
      CHANNELID_PARAMETER2 = 4, //!< Channel ID for Parameter2
    };
  ...
  PROTECTED:
    ...
    void tlmWrite_PktState(
        Ref::PacketStat& arg /*!< The telemetry value*/
    );
